...
[ ]() | <ul><li>[modules/data/](https://github.com/code4policy/modules/tree/master/data)</li><li>[assignment Section A](https://classroom.github.com/a/pP94cFu_)</li><li>[Assignment Section B](https://classroom.github.com/g/sc4dZP01)</li></ul>
...
Video  | Reading| Coding | Project
-------|-------|-------|-------|
-- |-- | [data conversions homework](https://github.com/code4policy/conversions)  **required **ONLY** if you don't use D3 for your project - Due with project (Jan 18) | Group work sprint 2 
